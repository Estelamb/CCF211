//=======================================
//Autores:
//Estela Miranda Batista - 3305
//João Marcos Alves Modesto Ramos - 3506
//Elida Emelly - 3012
//=======================================
...
void Partida(TipoCaixeiro *Caixeiro, char *mat1, char *mat2, char *mat3){
  ...
  matricula1 = (mat1[0] - '0') + (mat1[1] - '0') + (mat1[2] - '0') + (mat1[3] - '0');
  matricula2 = (mat2[0] - '0') + (mat2[1] - '0') + (mat2[2] - '0') + (mat2[3] - '0');
  matricula3 = (mat3[0] - '0') + (mat3[1] - '0') + (mat3[2] - '0') + (mat3[3] - '0');

  //Retorno do ponto de partida
  Caixeiro->PontoDePartida = (matricula1 + matricula2 + matricula3)%Caixeiro->NumCidades;
}
